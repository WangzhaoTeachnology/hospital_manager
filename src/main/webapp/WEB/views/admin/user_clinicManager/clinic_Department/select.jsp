                              ...
                              <div class="row">
                                  <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                                      <div class="col-lg-3 col-sm-3 col-md-3 col-xs-3">
                                          <label for="startime">挂号开始时间:</label>
                                           <input type="date"  id="startime"  class="form-control" />
                                      </div>
                                      <div class="col-lg-3 col-sm-3 col-md-3 col-xs-3">
                                          <label for="endtime">挂号结束时间:</label>
            ...
            <table width="95%" border="0" cellpadding="0" cellspacing="0" class="table02" align="center">
                <tr>
                    <td height="30" align="right">
                        <a href="${pageContext.request.contextPath}/admin/userForPatient/searchPatientsInfoByCondition?currentPage=${1}&&menuid=${menuid}&&search=${search}&&conditon=${condition}">
                        ...
                        <c:if test="${page.currentPage!=1&&page.currentPage==page.totalPage}">
                            ...
                            <a  href="${pageContext.request.contextPath}/admin/userForPatient/searchPatientsInfoByCondition?currentPage=${page.totalPage}&&menuid=${menuid}&&search=${search}&&conditon=${condition}">
                                <img src="${pageContext.request.contextPath}/static/admin/images/2-2.gif" width="3" height="5" align="absmiddle"> 下一页
                            </a>
                        </c:if>
                        <a  href="${pageContext.request.contextPath}/admin/userForPatient/searchPatientsInfoByCondition?currentPage=${page.totalPage}&&menuid=${menuid}&&search=${search}&&conditon=${condition}">
                          ...
                          success:function (data) {
                              ...
                              if (type=='success') {
                                  ...
                                  var  content=" <div class=\"form-horizontal\" style=\"border:0px solid red;text-align:center;margin-left: 100px;\">\n" +
                                      ...
                                      "                        <div class=\"form-group\">\n" +
                                      "                            <label for=\"number\" class=\"col-sm-2 control-label\">挂号编号</label>\n" +
                                      "                            <div class=\"col-sm-6 col-lg-6 col-xs-6 col-md-6\">\n" +
                                      "                                <input type=\"text\" name=\"id\" class=\"form-control\" readonly='readonly' id=\"id\"  value= "+json_appointment.id +" >\n" +
                                      "                            </div>\n" +
                                      "                        </div>\n" +
        ...
        $("input[name='search']").click(function () {
            ...
            if (search!=null&&search!=""){
                 if (conditon!=null&&conditon!=""){
                     ...
                     //其他的条件。同时这个search不为空，
                     window.location.href="${pageContext.request.contextPath}/admin/userForPatient/searchPatientsInfoByCondition?search="+search+"&&menuid="+menuid+"&&conditon="+conditon;
                 }
                ...
                if (conditon=="今天"){
                    ...
                    if (startime!=null&&startime!=""&&endtime!=null&&endtime!=""){
                        ...
                        if(start >=end){
                            ...
                            window.location.href="${pageContext.request.contextPath}/admin/userForPatient/searchPatientsInfoByCondition?search="+search+"&&menuid="+menuid+"&&conditon="+conditon+"&&startime="+start+"&&endtime="+end;
                            return;
                        }
                    }
                    window.location.href="${pageContext.request.contextPath}/admin/userForPatient/searchPatientsInfoByCondition?search="+search+"&&menuid="+menuid+"&&conditon="+conditon;
...
/*
            if (search!=null&&search!=""){
                ...
                }else if (conditon=='挂号编号'){

                }
                else if (conditon=='身份证编号'){
