                ...
                <table width="95%" border="0" cellpadding="2" cellspacing="0" class="table01">
                    ...
                    <c:forEach items="${userInfo}" var="user">
                        <tr>
                            <td class="td_01">
                                <span class="td01">
                                  <input name="checkbox" type="checkbox" value="${user.id}" >
                               </span>
                            </td>
            ...
            <form id="addform">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="align-content: center;" id="bodymain">
                        <%--      &lt;%&ndash;   这个是点击添加按钮显示出来的表单信息&ndash;%&gt;
                                <div class="form-horizontal" style="border:0px solid red;text-align:center;margin-left: 100px;">
                                     ...
                                     <div class="form-group">
                                         ...
                                         <div class="col-sm-6 col-lg-6 col-xs-6 col-md-6" style="margin-left: -70px;">
                                             <input type="radio"  id="male" name="radio" value="0"   placeholder="Password" checked="checked">男
                                             <input type="radio"  id="female"  name="radio"  value="1" placeholder="Password"> 女
                                         </div>
                                     </div>
