...
<body>
	...
	<script src="${pageContext.request.contextPath}/static/doctor/doctorsWorkJs/calendar/5e2922d339d9e/js/jquery.min.js"></script>
	<script src="${pageContext.request.contextPath}/static/doctor/doctorsWorkJs/calendar/5e2922d339d9e/js/amazeui.min.js" charset="utf-8"></script>
	<script src="${pageContext.request.contextPath}/static/doctor/doctorsWorkJs/calendar/5e2922d339d9e/js/timedropper.js" charset="utf-8"></script>
	<script src="${pageContext.request.contextPath}/static/doctor/doctorsWorkJs/calendar/5e2922d339d9e/js/calendar.js" charset="utf-8"></script>
	<script type="text/javascript">
		_loading_calendar("div1","cn");
	</script>
</html>