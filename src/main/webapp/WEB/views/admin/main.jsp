...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
                ...
                <table width="95%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="15"><img src="../images/index_57.gif" width="15" height="16"></td>
                          <td valign="top" class="td08"><a href="#">请归还2004-12-20日借阅的李月、王云峰、吴宏、张华的档案</a></td>
                        </tr>
                        <tr>
                          <td><img src="../images/index_57.gif" width="15" height="16"></td>
                          <td valign="top" class="td08"><a href="#">请及时处理李丽、欧阳小强、刘小军、施晓华的培训申请</a></td>
                        </tr>
                        <tr>
                          <td><img src="../images/index_57.gif" width="15" height="16"></td>
                          <td valign="top" class="td08"><a href="#">借阅的图书资料已超过归还日期，请及时归还</a></td>
                        </tr>
                        <tr>
                          <td><img src="../images/index_57.gif" width="15" height="16"></td>
                          <td valign="top" class="td08"><a href="#">2004-12-23 下午在407举行人力资源部年度考核大会，请准时参加</a></td>
                        </tr>
                    </table></td>
                  </tr>
                </table>
    ...
    <td width="190" align="center" valign="top" background="../images/main_17.gif"><br>
      ...
      <tr>
        <td height="25"><img src="${pageContext.request.contextPath}/static/admin/images/main_30.gif" width="9" height="9" align="absmiddle"> <strong>个人信息</strong></td>
        </tr>
      </table>
          <table width="163" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="5"><img src="${pageContext.request.contextPath}/static/admin/images/main_65.gif" width="5" height="5"></td>
              <td background="${pageContext.request.contextPath}/static/admin/images/main_66.gif"><img src="${pageContext.request.contextPath}/static/admin/images/spacer.gif" width="1" height="1"></td>
              <td width="5"><img src="${pageContext.request.contextPath}/static/admin/images/main_69.gif" width="5" height="5"></td>
            </tr>
            <tr>
              <td background="${pageContext.request.contextPath}/static/admin/images/main_70.gif"><img src="${pageContext.request.contextPath}/static/admin/images/spacer.gif" width="1" height="1"></td>
              <td class="td06"><table width="100%" border="0" cellspacing="4" cellpadding="0">
                  <tr>
                    <td>${user.username} 先生，您好！<br>
                      欢迎登录人民医院管理系统<br>
                      <br>
                      上次登录时间为：<br>
                      <span class="F01">${lastime}</span><br>
                      这是您第${count}次登录本系统</td>
                  </tr>
              </table></td>
              <td background="${pageContext.request.contextPath}/static/admin/images/main_72.gif"><img src="../images/spacer.gif" width="1" height="1"></td>
            </tr>
            <tr>
              <td><img src="${pageContext.request.contextPath}/static/admin/images/main_80.gif" width="5" height="5"></td>
              <td background="${pageContext.request.contextPath}/static/admin/images/main_81.gif"><img src="../images/spacer.gif" width="1" height="1"></td>
              <td><img src="${pageContext.request.contextPath}/static/admin/images/main_82.gif" width="5" height="5"></td>
            </tr>
          </table>
          <br>
          <table width="163" border="0" cellspacing="0" cellpadding="0">
...
//  End -->
          ...
          <table width="163" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td><a href="tongxunlu/index.htm" target="mainFrame" class="a03">个人通讯录</a><br>
          ...
          <table width="163" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="1" background="../images/main_57.gif"><img src="${pageContext.request.contextPath}/static/admin/images/spacer.gif" width="1" height="1"></td>
            </tr>
          </table>
          <table width="163" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="50" height="50"><img src="${pageContext.request.contextPath}/static/admin/images/icon_38.gif" width="36" height="36"></td>
              <td><a href="${pageContext.request.contextPath}/admin/selectAdminInfo" class="a03">个人设置</a><br>
                  <img src="../images/main_50.gif" width="43" height="9"></td>
            </tr>
    </table>
          <table width="163" border="0" cellspacing="0" cellpadding="0">
