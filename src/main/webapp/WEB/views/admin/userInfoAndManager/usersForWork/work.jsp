...
<html>
	<head>
		...
		<link rel="stylesheet" href="${pageContext.request.contextPath}/static/doctor/doctorsWorkJs/calendar/5e2922d339d9e/css/calendar.css">
		<link rel="stylesheet" href="${pageContext.request.contextPath}/static/doctor/doctorsWorkJs/calendar/5e2922d339d9e/css/amazeui.min.css">
		<link rel="stylesheet" href="${pageContext.request.contextPath}/static/doctor/doctorsWorkJs/calendar/5e2922d339d9e/css/timedropper.css">
...
<body>
       <%
		   Object works = request.getAttribute("works");
	   %>
		<div class="row" style="padding-left: 310px;margin-top: 20px;">
			<input type="hidden" name="doctorId" value="${user.id}" id="doctorId" />
	...
	<script src="${pageContext.request.contextPath}/static/user/doctorsWorkJs/calendar/5e2922d339d9e/js/jquery.min.js"></script>
	<script src="${pageContext.request.contextPath}/static/user/doctorsWorkJs/calendar/5e2922d339d9e/js/amazeui.min.js" charset="utf-8"></script>
	<script src="${pageContext.request.contextPath}/static/user/doctorsWorkJs/calendar/5e2922d339d9e/js/timedropper.js" charset="utf-8"></script>
	<script src="${pageContext.request.contextPath}/static/user/doctorsWorkJs/calendar/5e2922d339d9e/js/calendar.js" charset="utf-8"></script>
	<script type="text/javascript">
		user_loading_calendar("div1","cn");
	</script>
</html>