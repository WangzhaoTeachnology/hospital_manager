...
public interface DoctorsForPatientMapper {
   ...
   //医生查询就诊信息，按照今天的挂号时间，查询医生的需要看的病人
    ...
    public List<Prescription> findPrescriptionsByDoctorId(Map<String,Object> map);
    public int getTotalfindPrescriptionsByDoctorId(Map<String,Object> map);
    ...
    //医生按照审核修改数据，提交,
    //修改那三个最普通的审核条件
    public int updateItemPrescriptionById(Map<String,Object> map);
    public int updatePrescriptionById(Map<String,Object> map);
    public int updatecheckByItemPrescriptionId(Map<String,Object> map);
