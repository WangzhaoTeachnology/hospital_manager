package com.chinasoft.hospital_manager.mapper.admin.examineAndVerify;


import com.chinasoft.hospital_manager.domain.Check;
...
@Repository
public interface ExamineAndVerifyMapper {

    //查询未审核的处方信息
    public List<Prescription> findAllPrescriptionByNoStatus(Map<String,Object> map);

    public int getTotalfindAllPrescriptionByNoStatus(Map<String,Object> map);
