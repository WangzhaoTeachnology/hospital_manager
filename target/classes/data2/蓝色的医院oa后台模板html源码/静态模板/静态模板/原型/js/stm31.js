...
stAHWS=1;
stAHWR=0;
nOP=nOP5=nIE=nIE4=nIE5=nNN=nNN4=nNN6=nMAC=nIEM=nIEW=nDM=nVER=st_delb=st_addb=0;st_reg=1;stnav();st_ttb=nIE||nOP&&(nVER>=6&&nVER<7);stHAL=["left","center","right"];stVAL=["top.jsp","middle","bottom"];stREP=["no-repeat","repeat-x","repeat-y","repeat"];stBDS=["none","solid","double","dotted","dashed","groove","ridge"];
