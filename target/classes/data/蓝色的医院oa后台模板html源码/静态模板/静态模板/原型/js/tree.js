...
function bottom(theName,imgName)
	{
	if(document.all[theName].style.display=="none")
		{

		document.all[theName].style.display="";
		document.all[imgName].src="../images/tree_2_29.gif";

		}
	else
		{
		document.all[theName].style.display="none";
		document.all[imgName].src="../images/tree_29.gif";
		}
	}
...
function menu(theName,imgName)
	...
	if(document.all[theName].style.display=="none")
		{
		document.all[theName].style.display="";
		document.all[imgName].src="/static/admin/images/tree_2_11.gif";
		}
	else
		{
		document.all[theName].style.display="none";
		document.all[imgName].src="/static/admin/images/images/tree_11.gif";
		}
	}
